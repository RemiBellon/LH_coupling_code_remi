...
DOMAIN = {
    'Lx_plasma': .10,                    # Plasma domain in radial direction (m)
    ...
    'Lz_plasma': 0.60,                  # Plasma domain in toroidal direction (m)
...
PLASMA['ne_points'] = [
    ...
    (0.01, 5.0e17),  # Steep Scrape-Off Layer (SOL) gradient
    (0.05, 5.0e17)   # Core plasma flat-top
]
