...
def run_2D_wave_map(mesh, gfu, cfg, save_dir, resolution=(300, 300)):
    ...
    Lx_tot, Lx_plasma, Lz_plasma = cfg.DOMAIN['Lx_tot'], cfg.DOMAIN['Lx_plasma'], cfg.DOMAIN['Lz_plasma']
    Lx_pml = cfg.DOMAIN['Lx_pml']
...
def run_pml_scan_dataset(solver, cfg, save_dir, m_power=12):
    ...
    for i in range(N_simulations):
        ...
        if n_perp_sq_p <= 0.0:
            ...
            ndofs, Gamma_E = 0, 1.0 # 100% reflection assigned immediately
            ...
            if aspect_ratio > 10000 or aspect_ratio < 1e-4:
                ...
                cfg.DOMAIN['Lz_plasma'] = Lz_plasma 
        ...
        try:
            ...
            print(f"  --> Success | Gamma_Radial: {Gamma_E_Radial:.2e} ")
            
        except Exception as e:
            print(f"  [!] Failed Physics State: {e}")
            ndofs, Gamma_E_Radial= 0, 1.0,
