...
WAVE = {
    ...
    'n_para': .0+0.0j,      # Parallel refractive index (imposed by multi-junctions phasing)
...
DOMAIN = {
    ...
    'Lx_wg': 0.08,                      # Constant size of the waveguides stubs (m) 
                                        # Total domain size in radial direction (m)
    'Lz_plasma': 0.30,                  # Plasma domain in toroidal direction (m)
    'Lz_pml': 0.2,                      # PLM domain in toroidal direction (m)
    'Lz_wall': 0.02,
...
PLASMA['ne_points'] = [
    ...
    (0.002, 1.0e18),  # Steep Scrape-Off Layer (SOL) gradient
    (0.05, 3.4e18)   # Core plasma flat-top
]